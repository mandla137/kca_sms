...
class Crud_model extends CI_Model { 
    ...
    function enquiry_category(){
        ...
        $page_data['purpose']   =   html_escape($this->input->post('purpose'));
        $page_data['whom']      =   html_escape($this->input->post('whom'));
    ...
    function insert_club(){
        ...
        $page_data['club_name']     =   html_escape($this->input->post('club_name'));
        $page_data['desc']          =   html_escape($this->input->post('desc'));
    ...
    function insert_circular(){
        ...
        $page_data['reference']     =   html_escape($this->input->post('reference'));
    ...
    function update_settings(){
        ...
        $data['description']    =   html_escape($this->input->post('running_session'));
        $this->db->where('type', 'session');
        $this->db->update('settings', $data);

        $data['description']    =   html_escape($this->input->post('footer'));
    ...
    function update_theme(){
        ...
        $data['description']    =   html_escape($this->input->post('skin_colour'));
