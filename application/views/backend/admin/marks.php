...
<?php if($class_id > 0 && $student_id > 0 && $exam_id > 0):?>	
	...
	<div class="col-sm-12">
    					...
    					<table cellpadding="0" cellspacing="0" border="0" class="table">
								<thead>
									<tr>
										...
										<td><?php echo get_phrase('1st term');?></td>
										<td><?php echo get_phrase('2nd term');?></td>
										<td><?php echo get_phrase('3rd term');?></td>
										<td><?php echo get_phrase('Final score');?></td>
        ...
        ?>
              ...
              <h5 id="error_message" class="alert alert-warning" style="display:none">The values entered must not be greater than 100 each</h5>
              <h5 id="for_f" class="alert alert-warning" style="display:none">F: needs to improve</h5>
