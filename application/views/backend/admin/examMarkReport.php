        ...
        <?php $select_sunject_with_class_id  =   $this->crud_model->get_subjects_by_class($class_id);
           ...
           ?>
						...
						<tr>
							...
							<td>
								<?php echo $general_select['exam_score'] + $general_select['class_score3'] + $general_select['class_score1'] + $general_select['class_score2'];?>
							</td>
...
<script>
        ...
        <?php $select_sunject_with_class_id  =   $this->crud_model->get_subjects_by_class($class_id);
            foreach ($select_sunject_with_class_id as $key => $class_subject_exam_student): 
                ...
                foreach ($update_subject_marks as $key => $general_select2):

                    $sum_Class_score_and_exam_score = $general_select2['class_score1'] + $general_select2['class_score2'] + $general_select2['class_score3'] + $general_select2['exam_score']; 
